...
## build cloudopscmd
cloudopscmdbuild_arm:  bindir readme  modtidy
...
cloudopscmdbuild_amd:  bindir readme modtidy
...
cloudopspackage:   cloudopscmdbuild_arm cloudopscmdbuild_amd readme gendoc
		@if [ -d bin ]; then \
